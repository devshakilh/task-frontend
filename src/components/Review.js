...
const Review = () => {
  ...
  return (
    ...
    <div className="max-h-[600px] scrollable-element px-4 max-w-[500px] overflow-x-auto text-blue-800 ">
...
<p className='flex items-center gap-2 text-gray-600 font-semibold'><span><MdOutlineFileUpload /></span> 25</p>
